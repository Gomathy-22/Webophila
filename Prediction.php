      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Prediction of cases</a>
          </div>
      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Prediction of active cases</h5>
                <p class="category">in the upcoming month</p>
                <div class="row">
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">June </h5>
          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">July</h5>
                <h3 class="card-title"><i class="tim-icons icon-delivery-fast text-info"></i> 23456</h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">August</h5>
                <h3 class="card-title"><i class="tim-icons icon-send text-success"></i> 556</h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
