      ...
      <div class="content">
        <div class="row">
          <div class="col-12">
			...
			<div class="title" id="feat" >
<div class="row" align="center"><div class="col-lg-12"><h3 class="card-title">EXPLORE OUR WEBSITE FEATURES</h3></div></div>
<div class="row"><div class="col-lg-12">1.  Counts of the cases in TamilNadu / Madurai </div></div>
<div class="row"><div class="col-lg-12">2.  Latest News of India </div></div>
<div class="row"><div class="col-lg-12">3.  Tweets of Honourable Health Minister Dr.Vijayabaskar </div></div>
<div class="row"><div class="col-lg-12">4. 	Language Independent </div></div>
<div class="row"><div class="col-lg-12">5.  Dark/Ligth theme </div></div>
<div class="row"><div class="col-lg-12">6.  Map of Hospitals in Madurai </div></div>
<div class="row"><div class="col-lg-12">7.  Chatbot to test if you have Covid-19 or not (based on symptoms) </div></div>
<div class="row"><div class="col-lg-12">8.  Rules and regulations to be followed in lockdown  </div></div>
<div class="row"><div class="col-lg-12">9.  Emergency Helpline number </div></div>
<div class="row"><div class="col-lg-12">10. Links for door delivery of grocery shops </div></div>
<div class="row"><div class="col-lg-12">11. E-Pass Registeration link </div></div>
<div class="row"><div class="col-lg-12">12. Area-wise grocery shops contact number </div></div>
<div class="row"><div class="col-lg-12">13. Precautions </div></div>
</div>
		<h2 class="card-title">Last 7 Days (Cumulative)</h2>
...
var chart_labels = ['FEB','MAR', 'APR', 'MAY'];
    ...
    $("#0").click(function() {
	  ...
	  data.datasets[0].label = "Active cases";
    ...
    $("#1").click(function() {
      ...
      var data = myChartData.config.data;
      data.datasets[0].data = chart_data;
	  data.datasets[0].label = "Cured cases";
      data.labels = chart_labels;
      myChartData.update();
    });
    ...
    $("#2").click(function() {
      ...
      var data = myChartData.config.data;
      data.datasets[0].data = chart_data;
	  data.datasets[0].label = "Confirmed cases";
      data.labels = chart_labels;
      myChartData.update();
    });
